...
Implementation: **FD-A + FD-B LANDED (PR #67 `baf5570`, PR #68 `385b609`)**
— the pure calculation API and contract pins, plus the cockpit inputs,
trajectory disclosures/chart, fingerprinting, and per-year Excel export,
are all on `main`.
