...
| Step 3C | Increment relative to `cf91374`; average-price and metric-layout implementation under review | [Handoff and evidence](2026-09-16-step3c-handoff.md), [duration contract](../design/delivery-duration-v1.md) |
