...
The September corrections (Steps 1–4, #86–#93), the [frontier result-identity follow-up](docs/audits/2026-09-22-frontier-handoff.md) (#94, `bd4bb88`), and the [frontier/floor export and retry follow-up](docs/audits/2026-09-22-floor-followup-handoff.md) (#95, `cc6b1e2`) are merged. The [current verification snapshot](docs/validation/current.md) is dated and tied to its recorded code head. This branch contains a separate multi-day/forecast-policy Excel provenance correction awaiting independent review; the #95 [verification snapshot](docs/validation/2026-09-22-floor-followup.md), #94 [snapshot](docs/validation/2026-09-22-frontier.md) and earlier 2026-09-20 record remain archived.
