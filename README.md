...
- **Auditable ordinary/joint dispatch failures** — daily solvers return typed status/message fields; the ordinary and joint-capacity batches exclude and count failed days instead of converting them to zero revenue
...
├── tests/                    # 1163 passing tests, heavily mocked; 2 PDF tests may skip
