...
│   ├── stochastic_dispatch.py # Extensive-form stochastic DA-commitment MILP (stochastic MILP Increment B1)
...
├── tests/                    # 741 passing tests, heavily mocked; 2 PDF tests may skip
