...
- `python -m pytest tests/ -v` — run all tests (478 passing tests, fully mocked, no network; 2 PDF chart-render tests may skip when local Kaleido is unavailable).
