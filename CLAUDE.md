...
- `python -m pytest tests/ -v` — run all tests (462 passing tests, fully mocked, no network; 2 PDF chart-render tests may skip when local Kaleido is unavailable).
